...
- [Representation–architecture co-design for language models](corpus/ml-techniques/representation-architecture-co-design-language-models.md) — representation changes the operator's information and cost problem; crossed controls separate representation, operator, and interaction effects.
- [Complex, phase-aware, and hyperspherical Transformer computation](corpus/ml-techniques/complex-phase-aware-hyperspherical-transformers.md) — positional rotation, complex score maps, spherical state, and shared or implicit depth are separate axes that require matched controls.
- [Vector-symbolic representations and algebra-aware neural processing](corpus/ml-techniques/vector-symbolic-algebra-aware-neural-processing.md) — binding, bundling, order, similarity, and cleanup form one representation–operator contract; crossed controls separate VSA state from algebra-aware retrieval.
